...
library(gt) # grammar of tables package
...
Self-rated health refers the question in which participants assess different dimensions of their own health; it is commonly used in health research.
...
### If you ask people to self-rate their health (poor, fair, good, etc)...
...
### then you can "predict" things like their health, income, and even mortality
...
### and if you can predict who is likely to have  poor health, low-income, or early mortality
...
## Is there a difference in the U.S. national self-rated physical and mental health averages in 2018 vs 2020?
...
```{r physical-health-201, fig.height=2.25, fig.width=3.75, dpi=200}
ggplot(health_by_year, aes(x = year, 
                           y = avg_phys_health,
                           color = physical_health,
                           group = physical_health)) +
...
.panel[.panel-name[Levene's Test]
...
**Null hypothesis**: There is no difference in mean averages in 2018 and 2021.

H_1: \mu_1 - \mu_2 \neq 0

**Alternate hypothesis**: There is a difference in mean averages in 2018 and 2021
...
We conducted two independent samples t-test was conducted to determine if self-rated physical health and self-rated mental health among U.S. adults differed from 2018 to 2021. The mean mental health in 2018 was 3.66 and in 2021 was 3.48. The difference, 0.18, was found to be statistically significant, p < 0.001. The mean physical health score in 2018 was 3.34 and in 2021 3.33. The difference, 0.01, was not found to be statistically significant p = 0.78.
...
* Generalizability (overgeneralization)
...
RStudio is an Integrated Development Environment for R, a programming language for statistical computing and graphics. It is available in two formats: 1) RStudio Desktop which you can download on your personal computer and 2) Rstudio Server 
...
- a [blog post](http://svmiller.com/blog/2018/02/r-markdown-xaringan-theme/) on how to use Xaringan
...
.panel[.panel-name[James Malloy]

![](img/J Malloy Headshot2.jpg)


James is a graduate student at Georgia State University earning his M.S. in Educational Research. Born and raised in the small town of Goldsboro, North Carolina, 

James earned his Bachelor's degree in Spanish as well as a Master of Arts in Teaching, both from the University of North Carolina at Chapel Hill. Upon graduating, James taught high school Spanish for 5 years and later went on to help underserved high school students gain admission to College at the non-profit, the Emily K Center. In 2021, James officially moved to the Metro Atlanta area to finish his degree program. James is fiercely passionate about equity in education and explores the uses of quantitative research methods and storytelling to achieve that goal.  


]<!-- end of panel -->

.panel[.panel-name[Patrice Powell]
